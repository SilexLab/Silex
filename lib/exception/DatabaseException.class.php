...
class DatabaseException extends CoreException {
	...
	public function show() {
		...
		$this->information .= '<strong>SQL type:</strong> '.UString::encodeHTML($this->dbType).'<br />'.NL;
		$this->information .= '<strong>SQL error number:</strong> '.UString::encodeHTML($this->errorNumber).'<br />'.NL;
		$this->information .= '<strong>SQL error message:</strong> '.UString::encodeHTML($this->errorDesc).'<br />'.NL;
